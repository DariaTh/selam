...
<div id="page-insurance-agency">
    ...
    <section class="section-about section-about_accessibility" >
        <div class="wrapper">
            ...
            <p class="text-block" data-aos="fade-in" data-aos-easing="linear" data-aos-duration="500">
            חברת סלע סוכנות לביטוח בע"מ מעוניינת בשיפור מתמיד. באם נתקלת בקושי או יש לכם הצעת שיפור נשמח לשמוע ממכם, צרו קשר.
            </p>
        </div>
    </section>
    ...
    <section class="section-about section-about_accessibility" >
        <div class="wrapper">
            ...
            <ul>
                ...
                <li>
                קיימים שירותי נכים נגישים  [מומלץ לרשום היכן]
                </li>
                <li>
        ...
        <div class="wrapper">
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                        שירות פרונטלי - קבלת קהל בימים א'-ה' בין השעות 08:00-18:00
                        </li>
                        <li>
                        טלפון:
                        </li>
                        ...
                        <li>
                        פניה באמצעות "צור קשר" באתר (לינק):
                        </li>
                        <li>
                        צ'אט / ווידיאו ציאט:
                        </li>
    ...
    <section class="section-about section-about_accessibility" >
        <div class="wrapper">
            ...
            <p class="text-block" data-aos="fade-in" data-aos-easing="linear" data-aos-duration="500">
            חברת .......... מאמינה ופועלת למען שוויון הזדמנויות במרחב האינטרנטי לבעלי לקויות מגוונות ואנשים הנעזרים בטכנולוגיה מסייעת לשימוש במחשב.
            </p>
        </div>
        <div class="wrapper">
            ...
            <ul>
                ...
                <li>
                מסמכים או סרטוני וידאו שעלו לאתר לפני אוקטובר 2017 ייתכן שלא נגישים באופן מלא. במידה שנתקלתם במסמך כזה או בסרטון, תוכלו לפנות לרכזת נגישות ב ............. ואנחנו נדאג להנגיש לכם את המידע.
                </li>
                <li>
